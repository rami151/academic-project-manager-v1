  ...
  template: `
          ...
          <div class="space-y-8">
            <div class="space-y-4">
              ...
              <p class="text-xl text-neutral-600 leading-relaxed">
                ProjectHub is your intelligent collaborative workspace. Generate tasks, prioritize automatically, and ship faster with AI-powered project management.
              </p>
            </div>

            <div class="flex flex-col sm:flex-row gap-4">
              <button routerLink="/dashboard" class="px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-lg font-semibold hover:shadow-lg transition-all transform hover:scale-105">
                Launch Dashboard
              </button>
              <button class="px-8 py-4 border-2 border-neutral-300 text-neutral-900 rounded-lg font-semibold hover:bg-neutral-50 transition-colors">
                See Demo
              </button>
            </div>
              ...
              <div class="relative bg-white rounded-2xl shadow-elevation p-8 border border-neutral-200">
                <div class="space-y-4">
                  ...
                  <div class="flex items-center justify-between">
                    <h3 class="font-bold text-neutral-900">Q1 Product Launch</h3>
                    ...
                    <div class="space-y-3">
                      ...
                      <div class="space-y-2">
                        <div class="bg-neutral-100 rounded-lg p-3 border-l-4 border-secondary-500">
                          <p class="text-sm font-medium text-neutral-900">Design mockups</p>
                        ...
                        <div class="bg-neutral-100 rounded-lg p-3 border-l-4 border-warning-500">
                          <p class="text-sm font-medium text-neutral-900">API setup</p>
                          <div class="flex items-center gap-2 mt-2">
                    ...
                    <div class="space-y-3">
                      ...
                      <div class="space-y-2">
                        <div class="bg-white rounded-lg p-3 border-l-4 border-primary-500 shadow-sm">
                          <p class="text-sm font-medium text-neutral-900">Frontend setup</p>
                          <div class="flex items-center gap-2 mt-2">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center space-y-4 mb-16">
          <h2 class="text-4xl lg:text-5xl font-bold text-neutral-900">
            Powerful Features for Smart Teams
          </h2>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="group p-8 rounded-xl border border-neutral-200 hover:border-success-300 hover:shadow-lg transition-all">
            ...
            <h3 class="text-lg font-bold text-neutral-900 mb-2">Analytics Dashboard</h3>
            <p class="text-neutral-600">
          ...
          <div class="group p-8 rounded-xl border border-neutral-200 hover:border-warning-300 hover:shadow-lg transition-all">
            ...
            <p class="text-neutral-600">
              Control access with owner, editor, and viewer roles. Perfect for academic teams and professional projects.
            </p>
          </div>
    ...
    <section class="py-20 lg:py-32 bg-gradient-to-br from-primary-600 to-secondary-600">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <button routerLink="/dashboard" class="px-8 py-4 bg-white text-primary-600 rounded-lg font-bold hover:shadow-lg transition-all transform hover:scale-105 inline-block">
          Launch Dashboard
        </button>
      </div>
    </section>
    ...
    <footer class="bg-neutral-900 text-neutral-400 py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 class="text-white font-bold mb-4">ProjectHub</h3>
            <p class="text-sm">The intelligent project management platform for modern teams.</p>
          </div>
          <div>
